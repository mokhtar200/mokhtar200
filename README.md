...
- **Omics Technologies**: RNA-Seq (Single-cell, Bulk), Spatial Transcriptomics, Cancer Genomics, Multi-Omics Integration, Exome, TCR, 16s rRNA, Shotgun Metagenomics, GWAS, CRISPR gRNA Design, Epigenomics
- **Bioinformatics Tools & Libraries**: Seurat, DESeq2, ggplot2, Monocle3, HISAT2, Kallisto, Bowtie2, BWA, FeatureCounts, MiXcr, TRUST4, QIIME2 , Mothur 
